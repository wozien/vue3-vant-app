...
class Domain {
   ...
   */
  constructDomain(fieldName, period, type, comparisonPeriod) {
   ...
   * @returns {Array}
   */
  stringToArray (domain, evalContext) {
